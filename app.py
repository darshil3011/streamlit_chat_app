...
def get_rag_response(search_params):
    ...
    rephrased_output = client.chat.completions.create(
    model="gpt-3.5-turbo",
    messages=[
        {"role": "system", "content": "You are given some info which is generated by AI using some internet search results. Rephrase it to make it more natural and conversational"},
